module WillPaginateRenderer
  class WebPageRenderer < WillPaginate::ActionView::LinkRenderer
    ...
    def to_html
      ...
      html << link("[«]".html_safe, 1)
      # html << "</li>"
      # html << "<li class=\"page-item\">"
      html << link("...", current_page - 5) if current_page >= 6
      # html << "</li>"
      for i in (single_page_start_number..single_page_end_number)
        html << page_number(i)
      end
      # html << "<li class=\"page-item\">"
      html << link("...", current_page + 5) if current_page <= total_pages - 6
      html << link("[»]".html_safe, total_pages)
      # html << "</li>"
    ...
    def page_number(page)
      if page == current_page
        ...
        html = ""
        html << link("[#{page}]", page, :rel => rel_value(page))
